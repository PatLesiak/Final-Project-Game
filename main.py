...
def main():
    ...
    level = 0
    lives = 3
    main_font = pygame.font.SysFont("arial black", 45)
    ...
    def redraw_window():
        ...
        if lost:
            lost_label = lost_font.render("Koniec GRY!", True, (255, 255, 255))
    ...
    while run:
        ...
        if len(enemies) == 0:
            ...
            for i in range(wave_length):
                enemy = Enemy(random.randrange(50, WIDTH - 100), random.randrange(-750, -100),
